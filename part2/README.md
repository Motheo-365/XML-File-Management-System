# MINI HAND-IN 2 :  Backend Implementation + CRUD + Vue Integration
...
## 1. Project Overview
  ...
  In this part it simulates a real-world backend for a University of Pretoria Campus Services Information Portral.
  ...
  This project is extended by implementing a RESTful backend system for managing XML and XSLT resources.

  The project demonstrates separation of concerns between:
    * CRUD operations on XML data (at service level using IDs)
    * CRUD operations on XSLT files
...
## 2. System Objectives
  The system was developed to demonstrate:
    ...
    * CRUD operations on XML and XSLT data and files
